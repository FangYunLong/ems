...
<div class="page-container" style="text-align: center;">
	<p class="f-20 text-success" style="font-size: 50px;margin-top: 200px">欢迎使用教务管理系统（简易版）—— 管理员端<span class="f-14"></span></p>
</div>
<footer class="footer mt-20" style="margin: 200px">
	<div class="container">
		Copyright © 2017 教务管理系统（简易版）. 保留所有权利. 
	</div>
</footer>
