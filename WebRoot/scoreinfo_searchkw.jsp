...
<%
	...
	List<ScoreInfo> scoreInfo = ScoreInfoDaoImpl.findScoreInfoBykw(keyword);
%>
				...
				<tbody>
					<tr class="text-c">
						...
						<td class="td-manage"><a title="编辑"
							href="scoreinfo-update.jsp" class="ml-5"
							style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>
						</a> <a title="删除" href="scoreinfoDelete.jsp" class="ml-5"
							style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i>
						</a></td>
					</tr>
				</tbody>
